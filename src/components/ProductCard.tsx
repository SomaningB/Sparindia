  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        />
        {product.isOffer && (
          <div className="absolute top-3 left-3 px-2 py-1 bg-red-500 text-white text-[10px] font-bold rounded-lg uppercase">
            Special Offer
          </div>
        )}
      </div>
      ...
      <div className="p-4 flex flex-col flex-1">
        <div className="flex-1">
          ...
          <h3 className="text-sm sm:text-base font-bold text-gray-900 line-clamp-1 mb-1 leading-tight">
            {product.name}
          </h3>
